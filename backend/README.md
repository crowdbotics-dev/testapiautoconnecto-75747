...
## Project Structure
    ...
    ├── testapiautoconnecto_75747  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_75747`
...
2. Clone this repo and `cd testapiautoconnecto_75747`
